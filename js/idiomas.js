...
const IDIOMAS = {
  es: {
    ...
    hero_etiqueta: "Páginas web + Google Maps · Apatzingán, Michoacán",
    ...
    hero_d1_num: "1 a 1", hero_d1_txt: "trato directo, sin intermediarios",
    hero_d2_num: "Gratis", hero_d2_txt: "diagnóstico para tu negocio",
    hero_d3_num: "En días", hero_d3_txt: "tu sitio publicado",

    prob_etiqueta: "El problema",
    prob_titulo: "Si no apareces en Google, no existes para quien está lejos",
    ...
    prob_antes: "Antes", prob_despues: "Después",
    prob_caja1_h3: "Te buscan y no apareces", prob_caja1_p: "Solo te encuentran los que ya te conocen de vista.",
    prob_caja2_h3: "Te buscan, te ven y te escriben", prob_caja2_p: "Te encuentran desde cualquier ciudad, te ven, te escriben y te pagan.",

    serv_etiqueta: "Servicios",
    serv_titulo: "Tu página, tu ficha en Google y tu WhatsApp",
    serv_intro: "Tres cosas que se complementan. Empieza por una o llévate las tres.",
    ...
    sv1_l1: "Tu página con tus fotos, tu menú y tu botón de WhatsApp", sv1_l2: "Se ve en celular y computadora", sv1_l3: "Publicado en internet con tu dirección", sv1_l4: "Actualizaciones incluidas en tu renta",
    ...
    sv2_l1: "Alta o mejora de tu ficha en Google Maps", sv2_l2: "Fotos, horarios y categorías correctas", sv2_l3: "Que tu ficha esté completa y responda a las reseñas, para que Google la muestre antes", sv2_l4: "Seguimiento de reseñas de clientes",
    ...
    serv_nota: "Cada negocio es distinto, por eso no publicamos un precio fijo. Cotiza gratis y te mandamos una propuesta a la medida.",

    met_etiqueta: "Cómo trabajamos",
    met_titulo: "De no aparecer a que te encuentren, en 4 pasos",
    met_intro: "Así trabajamos con cada negocio, paso por paso.",
    p1_titulo: "Diagnóstico gratuito", p1_texto: "Nos cuentas tu negocio y revisamos cómo te encuentran hoy en internet.",
    p2_titulo: "Propuesta clara", p2_texto: "Te mandamos qué incluye y cuánto cuesta, todo por escrito.",
    ...
    faq_titulo: "¿Te quedan dudas? Aquí las resolvemos",
    faq_q1: "¿Cuánto cuesta?",
    faq_a1: "Cada negocio es distinto, por eso no publicamos un precio fijo. Te hacemos un diagnóstico gratuito y te mandamos una propuesta a la medida.",
    ...
    cont_titulo: "Cuéntanos de tu negocio y te respondemos en horario hábil",
    cont_intro: "Diagnóstico gratuito. Sin compromiso.",
    campo_nombre_label: "Tu nombre", campo_nombre_ph: "Ej. María López",
    campo_negocio_label: "Nombre de tu negocio", campo_negocio_ph: "Ej. Salón La Parota",
    ...
    pie_texto: "Páginas web, Google Maps y WhatsApp · Apatzingán, Michoacán",
  ...
  en: {
    ...
    hero_etiqueta: "Websites + Google Maps · Apatzingán, Michoacán",
    ...
    hero_d1_num: "1-on-1", hero_d1_txt: "direct attention, no middlemen",
    hero_d2_num: "Free", hero_d2_txt: "diagnosis for your business",
    hero_d3_num: "In days", hero_d3_txt: "your site published",

    prob_etiqueta: "The problem",
    prob_titulo: "If you don't show up on Google, you don't exist for those far away",
    ...
    prob_antes: "Before", prob_despues: "After",
    prob_caja1_h3: "They search and you don't show up", prob_caja1_p: "Only those who already know you in person can find you.",
    prob_caja2_h3: "They search, find you, and message you", prob_caja2_p: "They find you from any city, see you, message you and pay you.",

    serv_etiqueta: "Services",
    serv_titulo: "Your website, your Google listing, and your WhatsApp",
    serv_intro: "Three things that work together. Start with one or get all three.",
    ...
    sv1_l1: "Your page with your photos, your menu, and your WhatsApp button", sv1_l2: "Looks great on mobile and desktop", sv1_l3: "Published online with your address", sv1_l4: "Updates included in your monthly fee",
    ...
    sv2_l1: "Create or improve your Google Maps listing", sv2_l2: "Correct photos, hours and categories", sv2_l3: "A complete listing that answers reviews, so Google shows it first", sv2_l4: "Tracking customer reviews",
    ...
    serv_nota: "Every business is different, so we don't publish a fixed price. Get a free quote and we'll send you a custom proposal.",

    met_etiqueta: "How we work",
    met_titulo: "From not showing up to being found, in 4 steps",
    met_intro: "This is how we work with every business, step by step.",
    p1_titulo: "Free diagnosis", p1_texto: "You tell us about your business and we check how you're found online today.",
    p2_titulo: "Clear proposal", p2_texto: "We send you what's included and the price, all in writing.",
    ...
    faq_etiqueta: "FAQ",
    faq_titulo: "Any doubts? We'll clear them up",
    faq_q1: "How much does it cost?",
    faq_a1: "Every business is different, so we don't publish a fixed price. We run a free diagnosis and send you a custom proposal.",
    ...
    cont_titulo: "Tell us about your business and we'll reply during business hours",
    cont_intro: "Free diagnosis. No commitment.",
    campo_nombre_label: "Your name", campo_nombre_ph: "e.g. Maria Lopez",
    campo_negocio_label: "Your business name", campo_negocio_ph: "e.g. La Parota Event Hall",
    ...
    pie_tel: "+52 443 579 4642",
    pie_texto: "Websites, Google Maps and WhatsApp · Apatzingán, Michoacán",
